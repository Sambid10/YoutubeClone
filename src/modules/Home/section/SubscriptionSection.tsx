      ...
      <ErrorBoundary fallback={<p>Error</p>}>
        ...
        >
          <div className="text-center">
            <h1 className="text-3xl font-semibold flex justify-center items-center gap-2">Latest</h1>
            <p className="text-xs text-gray-700">Videos from your favourite creator..</p>
          </div>
