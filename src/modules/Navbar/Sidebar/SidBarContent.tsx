      ...
      <div className="flex flex-col gap-0 w-full">
        {sidebarItems.map((item) => (
          <Link
            ...
            href={item.href}
            className={`${
              isActive(item.href) ? "bg-gray-200 text-black" : "text-gray-900"
            } rounded-md hover:bg-gray-200 ease-in duration-200 transition-colors cursor-pointer text-sm py-2.5 pl-2 flex items-center gap-7`}
          >
